export default class Config {
    ...
    public static log_directory = process.env.TYPESCRIPTUSERS_LOG_DIRECTORY;
    public static log_level = process.env.TYPESCRIPTUSERS_LOG_LEVEL;
    public static production_mode = process.env.TYPESCRIPTUSERS_PRODUCTION_MODE;
}